...
void AstPrinter::Print(const Expression* expression, unsigned int indent) noexcept
{
...
void AstPrinter::Print(const Yac::Syntax::Statement* statement, unsigned int indent) noexcept
{
